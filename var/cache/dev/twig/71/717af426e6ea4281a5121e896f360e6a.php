...
class __TwigTemplate_46de5dd9ce323198368c0c4108d493e7 extends Template
{
    private $source;
    private $macros = [];
                    ...
                    <div class=\"container\">
                        <div class=\"row justify-content-center\">
                            <div class=\"col-lg-7\">
                                ...
                                <div class=\"card-header\"><h3 class=\"text-center font-weight-light my-4\">Create new Tickets</h3></div>
                                    <div class=\"card-body\">
                                        <div class=\"row mb-3\">
                                            ";
        // line 18
...
{% block title %}New Tickets{% endblock %}
                        ...
                        <div class=\"row justify-content-center\">
                            <div class=\"col-lg-7\">
                                ...
                                <div class=\"card-header\"><h3 class=\"text-center font-weight-light my-4\">Create new Tickets</h3></div>
                                    ...
                                    <div class=\"card-footer text-center py-3\">
                                        <div class=\"small\"><a href=\"{{ path('app_user_client_index') }}\">Dashboard</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
{% endblock %}
", "ticket/new.html.twig", "D:\\IPNET\\PROJET\\PPE Groupe ASSIH-TCHANGAI\\App\\tickets\\templates\\ticket\\new.html.twig");
    }
}
